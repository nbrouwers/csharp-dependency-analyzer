...
## Date: 2026-04-15 10:21:07 UTC

*Generated by C# Dependency Analyzer v3.1.0+7e5edf1a3ff1fca20e5be44fe182cf8fcb103e40*
...
| 6 | `SampleApp.Infrastructure.OrderTypeRegistry` | Class | Reflection: Type.GetType string literal `OrderService` |
| 7 | `SampleApp.Services.AdminController` | Class | Inherits from `OrderController` (which is a transitive fan-in of `OrderService`) |
| 8 | `SampleApp.Services.OrderController` | Class | Field type `OrderService` |
| 9 | `SampleApp.Services.OrderFactory` | Class | Method return type `OrderService` |
| 10 | `SampleApp.Services.OrderInspector` | Class | Type check (is/as) `OrderService` |
| 11 | `SampleApp.Services.OrderLogger` | Class | Local variable type `OrderService` |
| 12 | `SampleApp.Services.OrderPipeline` | Class | Constructor parameter type `OrderService` |
...
graph LR
    ...
    n6["OrderTypeRegistry"]:::kind_class
    n7["AdminController"]:::kind_class
    n8["OrderController"]:::kind_class
    n9["OrderFactory"]:::kind_class
    n10["OrderInspector"]:::kind_class
    n11["OrderLogger"]:::kind_class
    n12["OrderPipeline"]:::kind_class
    n1 --> n0
    n4 --> n0
    n12 --> n0
    n3 --> n0
